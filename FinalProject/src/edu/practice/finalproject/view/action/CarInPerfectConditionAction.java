...
public class CarInPerfectConditionAction extends ManagerAction {
	...
	private static final String CAR_REVIEWED_AS_BEING_IN_PERFECT_CONDITION_MSG = "car.in.perfect.condition.action.perfect-condition";
	...
	public boolean execute(HttpServletRequest req, EntityManager entityManager) {
		...
		try {
			...
			FCServlet.setMessage(req, CAR_REVIEWED_AS_BEING_IN_PERFECT_CONDITION_MSG, carReview.getLeaseOrder().getCar());
			return true;
